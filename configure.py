...
def main():
    ...
    if(args.prefix):
        ...
        cmd = "setUpScripts/generateCompFile.py -prefix "  + prefix + " -installName bibcppDev -outFilename compfile.mk -externalLoc " + external + " -CC " + CC + "  -CXX " + CXX + " -neededLibs cppitertools,r -outname bibcppDev "

    else:
        cmd = "setUpScripts/generateCompFile.py "  + " -installName bibcppDev -outFilename compfile.mk -externalLoc " + external + " -CC " + CC + "  -CXX " + CXX  + "  -neededLibs cppitertools,r -outname njhRInside "
